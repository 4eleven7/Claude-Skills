---
name: metal
description: Use when implementing, reviewing, or debugging Metal graphics or compute code: render/compute pipelines, MSL shaders, MTKView, command buffers, textures, frame pacing, GPU capture, or SwiftUI integration.
---
