---
name: swiftdata
description: Use when writing or reviewing SwiftData models, queries, migrations, schema policy, runtime patterns, or persisted schema changes.
---
...
Writes, reviews, and governs SwiftData persistence — modelling, queries, migrations, schema policy, and runtime patterns. Use when reading, writing, or reviewing any SwiftData code or persisted schema changes.
...
- `references/persistence-governance.md`
- `references/predicates-and-queries.md`
