---
name: file-storage
description: Use when deciding where iOS files should be stored, choosing Documents vs Caches vs Application Support vs tmp, handling backup exclusion, disk pressure, file protection, atomic writes, or file I/O races.
---
