---
name: cloudkit
description: Reviews and writes iCloud sync code — CloudKit databases, CKSyncEngine, SwiftData+CloudKit integration, iCloud Drive documents, NSUbiquitousKeyValueStore, conflict resolution, and sync diagnostics. Use when implementing, reviewing, or debugging any iCloud data sync.
---
...
**Does NOT own:** Local-only persistence (see swiftdata/core-data skills), server-side API design, authentication token management, UI loading states (see swiftui-mastery).
