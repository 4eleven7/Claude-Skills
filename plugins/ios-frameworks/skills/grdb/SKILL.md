---
name: grdb
description: Use when writing or reviewing GRDB records, SQL, migrations, associations, observation, concurrency, or persistence safety.
---
...
Writes, reviews, and governs GRDB persistence — record types, query interface, associations, migrations, observation, concurrency, and SQL safety. Use when reading, writing, or reviewing any GRDB code.
...
- `references/records-and-queries.md`
