...
description: Use when planning or debugging app discoverability through App Intents, Spotlight, Siri suggestions, Action Button, or Control Center.
---
...
Use when planning, reviewing, or debugging app discoverability through App Intents, Core Spotlight, NSUserActivity, IndexedEntity, Siri suggestions, Action Button, or Control Center.
