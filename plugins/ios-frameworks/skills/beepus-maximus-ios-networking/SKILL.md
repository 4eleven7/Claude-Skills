---
name: networking
description: Reviews and writes iOS networking code — URLSession for HTTP, Network.framework for custom protocols, iOS 26+ NetworkConnection async patterns, connection diagnostics, and common anti-patterns. Use when implementing, reviewing, or debugging any network connection.
---
...
**Does NOT own:** Server-side API design, backend architecture, GraphQL schema, authentication token management (see ios-architecture), UI loading states (see swiftui-mastery).
