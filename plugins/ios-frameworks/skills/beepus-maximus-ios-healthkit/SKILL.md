---
name: healthkit
description: Writes, reviews, and governs HealthKit integration — authorization, data types, samples, queries, workouts, background delivery, and HealthKit UI. Use when reading, writing, or reviewing any HealthKit code.
---
