---
name: swiftdata
description: Writes, reviews, and governs SwiftData persistence — modelling, queries, migrations, schema policy, and runtime patterns. Use when reading, writing, or reviewing any SwiftData code or persisted schema changes.
---
