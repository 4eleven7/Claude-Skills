---
name: grdb
description: Writes, reviews, and governs GRDB persistence — record types, query interface, associations, migrations, observation, concurrency, and SQL safety. Use when reading, writing, or reviewing any GRDB code.
---
