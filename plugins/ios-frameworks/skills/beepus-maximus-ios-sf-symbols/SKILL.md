---
name: sf-symbols
description: Use when working with SF Symbols rendering modes, symbol effects, symbol animation, palette/hierarchical/multicolor styles, variable symbols, custom symbols, or symbol accessibility.
---
