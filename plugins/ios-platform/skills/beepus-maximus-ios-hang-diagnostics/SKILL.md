...
description: Diagnoses and resolves app hangs — main thread blocking, watchdog terminations, MetricKit hang reports, and Swift concurrency deadlocks. Use when app freezes, UI unresponsive, or Xcode Organizer shows hang diagnostics.
---
