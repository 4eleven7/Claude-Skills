---
name: ios-ux-writing
description: UX writing for iOS app interfaces — voice, microcopy, alerts, errors, empty states, buttons, destructive actions, and accessibility labels. Use when writing or reviewing any user-facing text in the app.
---
...
- Marketing copy for App Store (see `shipping`)
