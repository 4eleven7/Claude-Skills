# iOS (iPhone) Human Interface Guidelines

Comprehensive rules derived from Apple's Human Interface Guidelines for iPhone. Apply these when building, reviewing, or refactoring any iPhone app interface.
