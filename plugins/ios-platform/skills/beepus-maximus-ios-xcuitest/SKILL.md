---
name: xcuitest
description: Reviews and writes XCUITest UI automation code — element queries, waiting patterns, accessibility identifiers, page objects, network conditioning, and crash debugging. Use when writing, reviewing, or debugging UI tests.
---
