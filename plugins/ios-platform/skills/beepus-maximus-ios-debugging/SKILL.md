---
name: debugging
description: Guides LLDB usage, runtime diagnostics, memory leak detection, and systematic debugging for iOS apps. Covers variable inspection, breakpoints, memory leak workflows, Jetsam diagnostics, and SwiftUI state debugging.
---
