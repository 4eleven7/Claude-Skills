...
description: Use when interpreting product analytics, diagnosing weak metrics, comparing cohorts, evaluating retention, sanity-checking LTV, ARPU, ARPPU, payback, App Store funnel data, or deciding whether to invest, iterate, pivot, or sunset.
---
