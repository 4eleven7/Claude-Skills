---
name: core-animation
description: Use when writing or reviewing CALayer, CAAnimation, UIViewPropertyAnimator, or UIKit animation bridges.
---
...
**Does NOT own:** SwiftUI animations (swiftui-patterns skill), Metal rendering, SpriteKit/SceneKit, RealityKit.
