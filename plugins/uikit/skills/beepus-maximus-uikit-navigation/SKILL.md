...
description: Reviews and writes UIKit navigation code — UINavigationController, modal presentations, UIPresentationController, custom transitions, coordinator pattern. Use when building or reviewing navigation flows in UIKit.
---
...
**Does NOT own:** SwiftUI NavigationStack (swiftui-mastery skill), tab bars in SwiftUI, view controller lifecycle (uikit-fundamentals skill), SwiftUI bridging (uikit-interop skill).
