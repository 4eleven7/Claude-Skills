---
name: swiftui-visual-review
description: Use when reviewing SwiftUI views for visual quality, accessibility, HIG fit, state coverage, polish, and design-system drift.
---
...
Use when reviewing SwiftUI views for visual quality, accessibility, HIG fit, state coverage, polish, and design-system drift.
