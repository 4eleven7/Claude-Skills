...
description: Use when building or reviewing SwiftUI Shader API effects such as colorEffect, distortionEffect, layerEffect, ShaderLibrary, Metal shader functions, ripple, pixel, or custom visual effects.
---
