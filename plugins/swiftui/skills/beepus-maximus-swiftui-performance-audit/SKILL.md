...
description: Use when diagnosing or improving SwiftUI performance: janky scrolling, slow rendering, high CPU or memory, excessive updates, identity churn, layout thrash, image cost, hangs, or profiling evidence.
---
...
Use `swiftui-mastery/references/performance.md` for detailed examples and remediation patterns.
