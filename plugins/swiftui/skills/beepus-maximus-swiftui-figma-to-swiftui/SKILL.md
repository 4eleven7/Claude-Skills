...
description: Use when translating Figma designs, selected Figma nodes, design tokens, or Figma assets into production SwiftUI for an iOS app. Requires an available Figma MCP/tool connection. Do not use for web or React implementation.
---
