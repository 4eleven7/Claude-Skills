...
```
Create a change summary since the last tag
Changelog for commits in the last 2 weeks
Release notes for v2.5.0
Store What's New copy for 2.5.0
```
...
- For store release copy, keep the final text concise and avoid markdown headings unless the user asks for a full change summary
