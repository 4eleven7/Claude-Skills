...
3. **One-line next step** — suggest `/plan --ux-audit` if fixes are needed
...
```
💡 To generate a phased fix plan from these findings, run: /plan --ux-audit
```
