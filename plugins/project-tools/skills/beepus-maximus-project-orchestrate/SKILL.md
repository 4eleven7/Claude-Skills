---
name: orchestrate
description: Coordinate agents to execute implementation plans. Dispatch implementers, run spec and quality reviews, handle status reports. Use when executing plans with multiple independent tasks.
---
