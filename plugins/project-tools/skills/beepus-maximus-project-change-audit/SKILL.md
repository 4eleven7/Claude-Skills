---
name: change-audit
description: Use when auditing or summarizing session changes, documenting what changed, explaining the root cause, listing verification, or producing rollback notes.
---
...
- **Commit** — invoke finalize or commit workflow
