...
description: Use when an agent repeatedly fails, needs manual context, cannot reproduce or verify a bug, cannot inspect runtime behaviour, or relies on copy-pasted human knowledge.
---
...
Use when an agent repeatedly fails, needs manual context, cannot reproduce or verify a bug, cannot inspect runtime behaviour, or relies on copy-pasted human knowledge.
