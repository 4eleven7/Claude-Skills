---
name: plan
description: Use when work requires a persistent multi-step plan, findings log, or progress file before implementation.
---
...
Use for persistent planning files and long-running progress tracking. Use `spec-workflow` for feature-spec content, `implement` for execution planning tied to code changes, and `session-handoff` for resumable checkpoints.
