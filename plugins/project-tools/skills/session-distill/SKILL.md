...
1. **Project instructions** — repo instructions or project guidance docs (conventions, architecture decisions)
...
4. **Improvements** — Run the `/capture-idea` skill to note each item.
