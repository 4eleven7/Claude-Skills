---
name: draft-spec
description: Interview the user about a feature idea and produce a structured implementation-ready specification.
---
...
3. Run `clarify-spec` skill if open questions remain
