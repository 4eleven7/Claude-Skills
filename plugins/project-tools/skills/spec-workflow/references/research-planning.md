...
Generate a structured set of research questions to guide deep technical investigation. This produces questions only, not answers. Use it before doing research so the investigation has a clear scope.

## When to Use

- Before diving into an unfamiliar technology or framework
- When planning a major architectural decision
- When scoping what to research before answering or investigating
...
Create the file at a project spec-workflow note for the topic.
...
Suggest: "Use this question set for the research pass, or refine the questions first."
