...
- Before `pr-shipping` skill on a non-trivial change
...
|---|---|---|
| Risk is LOW, tests pass | `pr-shipping` skill | Safe to ship |
| Uncovered test paths found | `small-change` skill to add tests | Cover gaps before shipping |
