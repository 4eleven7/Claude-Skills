...
Use for researching competitor apps and writing structured competitor entries. Use `reference-library` to save a repo or article without competitive analysis, `skill-research` for technology research, and `app-store-marketing` for ASO or store listing strategy.
...
Use the user request, selected files, selected text, or current repo context as input. The input should identify an app listing URL, website URL, or app name.

## Process

### Step 1: Research the App

Fetch the app listing and/or website. Extract:

- **Name** (display name)
- **Store listing / Website URL(s)**
- **Developer**
...
If the URL is a store listing, also try to find the developer's website from the listing. If only a name is given, search the web to find the canonical app listing.

### Step 2: Determine the Category

Locate the project competitor research document before writing. Search common documentation and planning folders for competitor, market, research, positioning, or reference documents. If no competitor research document exists, ask the user where to store the entry or whether to create one.

Read the section headings in the located competitor research document. Either:
...
- Place the entry in the correct section of the located competitor research document
